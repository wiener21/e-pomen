export default function Page() {
    return (
        <div className='container mx-auto md:w-1/2 w-4/5'>
            ...
            <p className="mt-6 mb-6">
                Naš cilj je da olakšamo porodicama i prijateljima proces objave informacija o smrti, pomena, sećanja, zahvalnosti. Jednostavnom procedurom, bez odlaska na šalter, korisniku je omogućeno brzo slanje objava, uz mogućnost onlajn plaćanja. Potvrdu o ispravnosti poslatog teksta, fotografija i materijala dobijate odmah.
            </p>
            <p className="mt-6 mb-6">
                ...
                na koje se obavezuju korisnici, odnosno pružalac usluge. 
            </p>
        </div>
    )
}
